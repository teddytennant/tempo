#!/usr/bin/env bash
# Build + packed-smoke + submit the Starmie v10 rules agent (masamikobayashi list + elite-mined pilot).
#   bash scripts/ship_starmie_v10.sh "submission message" [--dry-run]
...
MSG="${1:?usage: ship_starmie_v10.sh <message> [--dry-run]}"
DRY="${2:-}"
DECK=data/decks/starmie.csv
OUT="/home/gradient/projects/ai/tempo/agent/submission_starmie_v10.tar.gz"
